...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_medium, col_dark, col_dark },
	...
	[SchemeTagsSel]  = { col_light, col_dark,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
	[SchemeTagsNorm]  = { col_medium, col_dark,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
	[SchemeInfoSel]  = { col_light, col_dark,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
	[SchemeInfoNorm]  = { col_medium, col_dark,  "#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_dark, "-nf", col_medium, "-sb", col_dark, "-sf", col_light, NULL };
